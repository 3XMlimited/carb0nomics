            ...
            <Fade triggerOnce={true}>
                <div className='h-fit w-full max-w-[1440px] p-[20px] flex flex-col items-start gap-[10px]'>
                    ...
                    <ul className='list-disc list-inside flex flex-col gap-y-[10px]'>
                        ...
                        <li>
                            <p className='font-normal text-justify leading-normal inline sm:text-sm'><span className='font-semibold'>Website</span> refers to Carb0nomics, accessible from <a className='text-blue-600' href="https://carb0nomics.com/" rel="external nofollow noopener" target="_blank">https://carb0nomics.com/</a></p>
                        </li>
                        <li>
