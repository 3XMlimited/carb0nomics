    ...
    <div className={`sticky top-0 z-50 h-[60px] w-full bg-white flex justify-center`}>
      {loginStatus.login ? (
        <div className='relative h-full w-full max-w-[1700px] flex items-center justify-between px-[20px]'>
          ...
          <div className='h-full grid grid-cols-3 items-center md:hidden'>
            <div className={`h-full flex items-center justify-center px-[10px] ${(currentRoute === 'dashboard') ? 'text-emerald-400' : ''} duration-200 cursor-pointer hover:text-emerald-400`} onClick={() => (currentRoute !== 'dashboard') && navigate('/dashboard')}>Home</div>
          ...
          <div className={`absolute top-full left-0 h-[calc(100vh-60px)] w-full origin-top-right duration-200 hidden md:flex ${displayMenu ? 'scale-100 opacity-100' : 'scale-0 opacity-0'}`}>
            <div className='h-fit max-h-full w-full bg-white grid grid-row-3 gap-[10px] p-[20px] overflow-y-scroll hide-scrollbar'>
              <div className={`h-[50px] w-full flex items-center justify-center p-x-[10px] ${(currentRoute === 'dashboard') ? 'text-emerald-400' : ''} duration-200 cursor-pointer hover:text-emerald-400`} onClick={() => {setDisplayMenu(!displayMenu); ((currentRoute !== 'dashboard') && navigate('/dashboard'));}}>Home</div>
        ...
        <div className='relative h-full w-full max-w-[1440px] flex items-center justify-between px-[20px]'>
          ...
          <div className='h-full grid grid-cols-7 items-center lg:hidden'>
            ...
            <div className={`h-full flex items-center justify-center px-[10px] ${(currentRoute === 'policy') ? 'text-emerald-400' : ''} duration-200 cursor-pointer hover:text-emerald-400`} onClick={() => (currentRoute !== 'policy') && navigate('/policy')}>Policy</div>
          ...
          <div className={`absolute top-full left-0 h-[calc(100vh-60px)] w-full origin-top-right duration-200 hidden lg:flex ${displayMenu ? 'scale-100 opacity-100' : 'scale-0 opacity-0'}`}>
            <div className='h-fit max-h-full w-full bg-white grid grid-row-6 gap-[10px] p-[20px] overflow-y-scroll hide-scrollbar'>
              ...
              <div className={`h-[50px] w-full flex items-center justify-center p-x-[10px] ${(currentRoute === 'policy') ? 'text-emerald-400' : ''} duration-200 cursor-pointer hover:text-emerald-400`} onClick={() => {setDisplayMenu(!displayMenu); ((currentRoute !== 'policy') && navigate('/policy'));}}>Policy</div>
