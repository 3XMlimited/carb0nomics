        ...
        {displayChange ? (
          <div className='h-fit w-full p-[20px] flex flex-col gap-[20px] items-center'>
            ...
            <div className='w-full max-w-[400px] flex flex-col'>
              ...
              <input type="text" placeholder='Check your email' value={details.code} onChange={e => setDetails(p => {return{...p, code: e.target.value}})} className={`h-[50px] w-full bg-white border-2 ${(error.code === '') ? 'border-slate-300' : 'border-red-400'} rounded-md px-[5px] focus:outline-none`}/>
            ...
            <button onClick={() => handleChangePassword()} className={`h-[50px] w-full max-w-[400px] text-white rounded-md px-[5px] flex items-center justify-center ${loading ? 'bg-gray-400' : 'bg-emerald-400'} duration-200 focus:outline-none hover:opacity-50 focus-visible:opacity-50`}>
            ...
            <button onClick={() => setDisplayChange(false)} className={`h-[50px] w-full max-w-[400px] text-red-300 rounded-md px-[5px] flex items-center justify-center bg-red-50 border-2 border-red-200 focus:outline-none hover:opacity-50 focus-visible:opacity-50`}>
              Back
            </button>
          ...
          <div className='h-fit w-full p-[20px] flex flex-col gap-[20px] items-center'>
            ...
            <button onClick={() => handleGetCode()} className={`h-[50px] w-full max-w-[400px] text-white rounded-md px-[5px] flex items-center justify-center ${loading ? 'bg-gray-400' : 'bg-emerald-400'} duration-200 focus:outline-none hover:opacity-50 focus-visible:opacity-50`}>
